...
public class PersonaController {
    ...
    public String cPost(
            ...
            @RequestParam(value = "idPaisNacimiento", required = false) Long idPaisNacimiento,
            @RequestParam(value = "idPaisResidencia", required = false) Long idPaisResidencia,
            @RequestParam(value = "idAfG[]", required = false) List<Long> idsAficionGusta,
            @RequestParam(value = "idAfO[]", required = false) List<Long> idsAficionOdia) throws DangerException {
        ...
        try {
            this.personaService.c(nombre, apellido, loginname, password, "user", idPaisNacimiento, idPaisResidencia,
                    idsAficionGusta, idsAficionOdia);
        } catch (Exception e) {
            PRG.error("Loginname "+loginname+" ya en uso", "/persona/c");
        }
    ...
    @PostMapping("d")
    public String d(
            @RequestParam("id") Long id) throws DangerException {
        try {
            personaService.d(id);
        } catch (Exception e) {
    ...
    public String uPost(
            ...
            @RequestParam("nombre") String nombre,
            @RequestParam("apellido") String apellido,
            @RequestParam("idPaisNacimiento") Long idPaisNacimiento,
        ...
        this.personaService.u(id, nombre, apellido, idPaisNacimiento, idPaisResidencia, idsAficionGusta,
                idsAficionOdia);
        return "redirect:/persona/r";
    }
    ...
    public String loginPost(
        ...
        try {
            Persona persona =  personaService.login(loginname, password);
            s.setAttribute("user", persona);
        } catch (Exception e) {
            PRG.error("Nombre de usuario o contraseña incorrectas", "/persona/login");
        }
        return "redirect:/";
    }
